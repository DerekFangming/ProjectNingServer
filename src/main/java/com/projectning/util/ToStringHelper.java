...
public class ToStringHelper
{
  ...
  public static StringBuilder variableToString(StringBuilder sb, String indent, String name, long value)
  {
    return variableToString(sb, indent, name, value, NEWLINE_YES);
  }
  ...
  public static StringBuilder variableToString(StringBuilder sb, String indent, String name, long value, boolean nl)
  {
    String result = variableToString(name, value);
    return formatResult(sb, indent, result, nl);
  }
  ...
  public static StringBuilder variableToString(StringBuilder sb, String indent, String name, String value)
  {
    return variableToString(sb, indent, name, value, NEWLINE_YES);
  }
  ...
  public static StringBuilder variableToString(StringBuilder sb, String indent, String name, String value, boolean nl)
  {
    String result = variableToString(name, value);
    return formatResult(sb, indent, result, nl);
  }
  ...
  public static StringBuilder variableToString(StringBuilder sb, String indent, String name, boolean value)
  {
    return variableToString(sb, indent, name, value, NEWLINE_YES);
  }

  public static StringBuilder variableToString(StringBuilder sb, String indent, String name, boolean value, boolean nl)
  {
    String result = variableToString(name, value);
    return formatResult(sb, indent, result, nl);
  }
  ...
  private static StringBuilder formatResult(StringBuilder sb,  String indent, String result, boolean nl)
  {
    if (sb == null)
    {
      sb = new StringBuilder();
...
*/
  ...
  {
    return mapToString(new StringBuilder(), true, "  ", map, true);
  }
  ...
  public static StringBuilder mapToString(StringBuilder sb, boolean indent,
      String indentHack, Map<String, String> map,
      List<String> simpleClassNameList, boolean nl)
  {
    for (String key : map.keySet())
    {
      if (indent)
      ...
      {
        sb = variableToString(sb, indent, key,
            Util.getSimpleClassType(map.get(key)), nl);
      }
      else
      {
        sb = variableToString(sb, indent, key, map.get(key), nl);
  ...
  public static String underscoreToCamelCase(String s)
  {
    ...
    for(String part : s.split("_"))
    {
      if(!part.isEmpty())
      {
        camelCase += part.substring(0,1).toUpperCase() + part.substring(1).toLowerCase();
      }
    }
